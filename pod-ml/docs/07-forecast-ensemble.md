...
**Trust weights** (200 cells): mean w=0.445, max w=0.782, 195/200 cells above w=0.30. Fitted on all-hours CRPS vs deterministic climatology baseline (MAE from clim mean), consistent with CRPSS reporting. Mean weight 44.55% → blend is ~55% climatology at the typical cell.
